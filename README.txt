...
installing
Ensure you have Git and either Ruby 1.9.3 or RVM installed. Then in a console execute:
...
I developed toy-robot test first; you can see the commit log for how I proceeded.
...
Existing issues can be logged on the Issues page; there is already one related to documentation generation.
